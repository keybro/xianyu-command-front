                        ...
                        <el-col :span="16">
                            <div style="text-align: left;border-left: 1px #e6e6e6 solid;border-right: 1px #e6e6e6 solid;border-top: 1px #e6e6e6 solid">
                                <div class="title" style="margin-top: 8px">
                                    <h4 style="margin-left: 10px">选择书籍</h4>
                                </div>
                                <div style="display: flex;margin-top: 10px">
                                    <p style="margin-left: 10px;margin-left: 10px;margin-top: 5px">图书类型:</p>
                                    <div style="margin-top: 20px;margin: 0px;margin-right: 0px;margin-left: 10px">
                                        <el-radio-group v-model="radio2" size="small" @change="getListByType()">
                                            ...
                                            <el-radio-button label="心理学"></el-radio-button>
                                            ...
                                            <el-radio-button label="社会学"></el-radio-button>
                                            <el-radio-button label="文化"></el-radio-button>
                                            <el-radio-button label="散文"></el-radio-button>
                                            <el-radio-button label="科普"></el-radio-button>
                                            <el-radio-button label="成长"></el-radio-button>
                             ...
                             <!--           书籍列表            -->
                                <div style="width: 100%;border-top: 1px #e6e6e6 solid;margin-top: 10px;border-right: 1px #e6e6e6 solid">
                                    <!--                 每个图书div                   -->
                                    <div class="content-list-div" style="margin-top: 10px;border-bottom: 1px #e6e6e6 solid;display: flex" v-for="(item, index) in bookList" :key="item" :offset="index > 0 ? 10 : 0">
...
<script>
    import {pageGetBookByType} from "../../api/book";
    ...
    export default {
        ...
        methods:{
            getListByType(){
                ...
                this.$set(params,"book_type",this.radio2)

                pageGetBookByType(params).then(resp =>{
